...
config :stackoverflow_clone, StackoverflowCloneWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "ZGLJROiAUEB41L8KKVawJaazNYQ3mPJBcBKqSiZo8G698ygmlUxR6LDCUX95Lbc8",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:stackoverflow_clone, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:stackoverflow_clone, ~w(--watch)]}
  ]
